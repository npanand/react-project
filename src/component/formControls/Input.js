...
function Input (props) {
  ...
  return (
    <div>
      ...
      <React.Fragment>{(type === "text" || type ==="number"||type ==="password"||type ==="email") && <Field type={type} className="form-control" id={name} name={name} {...rest} placeholder= {(props.placeholder) ? props.placeholder: name} />}</React.Fragment>
